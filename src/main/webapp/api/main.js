/**
 * Created by xxq on 2017/9/1.
 */

/**
 * @api  {post} v3/apply/register 用户注册
 * @apiVersion 0.1.0
 * @apiname register
 * @apiGroup User
 ...
 * @apiSuccess {Boolean} data   true 成功 false 失败
 *
 *
...
/**
 * @api  {get} v3/apply/isBlacklist 黑名单检测
 * @apiVersion 0.1.0
 * @apiname isBlacklist
 * @apiGroup Apply
 *
 * @apiParam {String} name 姓名
 * @apiParam {String} identityId 身份证号
 *
 * @apiSuccess {String}   success   正确错误
 * @apiSuccess {String}   message   消息
 * @apiSuccess {Object} data   返回数据
 * @apiSuccess {boolean} isBlacklist   黑名单：true, 不是黑名单：false
 *
 *
 * @apiSuccessExample {json} Success Example:
 * {
...
/**
 * @api  {post} v3/order/finish 订单完成提交
 * @apiVersion 0.1.0
 * @apiname applyAdd
 * @apiGroup Apply
 ...
 *
 * @apiParam {String} orderNo 商户订单号，保证唯一
 * @apiParam {String="C12"} productCode 合作产品码
 * @apiParam {String} mobile 手机号
 * @apiParam {String} identityId 身份证号
 * @apiParam {String} name 姓名
 * @apiParam {String} corpName 公司名称
 * @apiParam {Object[]} contacts 联系人信息
 * @apiParam {String} contacts.name 联系人姓名
 * @apiParam {String} contacts.mobile 联系人手机号
 * @apiParam {String} contacts.relation 联系人关系
 *
 * @apiSuccess {String}   success   正确错误
 * @apiSuccess {String}   message   消息
 * @apiSuccess {Boolean} data   true 成功 false 失败
 * @apiSuccess {String} data.applyId   投融家申请ID
 * @apiSuccess {number} data.status  申请状态
 *
 *
 * @apiParamExample {json} Example:
 {"productCode":"C12","contacts":[{"name":"同一1","mobile":"13429151111","relation":"子女"},{"name":"同一2","mobile":"13429151112","relation":"朋友"},{"name":"同一3","mobile":"13429151113","relation":"同事"}],"name":"老五","mobile":"13429151266","identityId":"430426198609166173","orderNo":"ODNO000101010100101"}
 * @apiSuccessExample {json} Success Example:
 * {
 *   "success": true,
 *   "message": "成功",
...
/**
 * @api  {get} v3/order/getLimitAuditList 获取额度批复列表信息
 * @apiVersion 0.1.0
 * @apiname getLimitAuditList
 * @apiGroup Apply
 * @apiParam {String="C12"} productCode 合作产品码
 * @apiHeader {String} Authorization 认证头信息: Bearer {access_token}
 * @apiHeaderExample {String} Head Example:
...
/**
 * @api  {get} v3/order/getRepayPlans 获取还款计划列表信息
 * @apiVersion 0.1.0
 * @apiname getRepayPlans
 * @apiGroup Apply
 * @apiParam {String} orderNo 商户订单号
 * @apiHeader {String} Authorization 认证头信息: Bearer {access_token}
 * @apiHeaderExample {String} Head Example:
 * Authorization: Bearer 4917172b-685e-4cdf-b518-21bb118018b5
 *
 ...
 * @apiSuccess {String}   message   消息
 * @apiSuccess {Object} data   返回数据
 * @apiSuccess {String} data.list.periodNumber   还款期数
 * @apiSuccess {String} data.list.repayDate   还款日期
 * @apiSuccess {String} data.list.repayAmount   还款金额
 * @apiSuccess {String} data.list.status   还款状态（0未还，1部分还款，2已还）
 * @apiSuccess {String} data.list.statusDescribe   还款状态描述
 *
 *
 * @apiSuccessExample {json} Success Example:
 {
...
/**
 * @api  {get} v3/order/tryDoRepayAmount 还款试算
 * @apiVersion 0.1.0
 * @apiname tryDoRepayAmount
 * @apiGroup Apply
 * @apiHeader {String} Authorization 认证头信息: Bearer {access_token}
 * @apiHeaderExample {String} Head Example:
 * Authorization: Bearer 4917172b-685e-4cdf-b518-21bb118018b5
 *
 * @apiParam {Integer} term 还款期数
 * @apiParam {String} amount 贷款金额
 * @apiParam {String} interest 利率
 *
 * @apiSuccess {String}   success   正确错误
 * @apiSuccess {String}   message   消息
 * @apiSuccess {Object} data   返回数据
 * @apiSuccess {Object.String} cutAmount     保险金额
 * @apiSuccess {Object.String} limitAmount   可用金额
 * @apiSuccess {Object.list} termList        还款计算列表
 * @apiSuccess {Object.list.term} termList.term               期数
 * @apiSuccess {Object.list.termAmount} termList.termAmount   还款金额
 *
 *
 * @apiSuccessExample {json} Success Example:
 *   {
...
/**
 * @api  {get} v3/order/signatureAccredit 即电子签章发送验证码接口
 * @apiVersion 0.1.0
 * @apiname signatureAccredit
 * @apiGroup Apply
 * @apiHeader {String} Authorization 认证头信息: Bearer {access_token}
 * @apiHeaderExample {String} Head Example:
 * Authorization: Bearer 4917172b-685e-4cdf-b518-21bb118018b5
...
/**
 * @api  {post} v3/order/doSignature 合同签章接口
 * @apiVersion 0.1.0
 * @apiname doSignature
 * @apiGroup Apply
 * @apiHeader {String} Authorization 认证头信息: Bearer {access_token}
 ...
 * @apiParam {BigDecimal} useAmount 提交金额
 * @apiParam {String} loanUseType 借款用途
 * @apiParam {BigDecimal} cutCharge 吹头息金额
 * @apiParam {String} term 期数
 * @apiParam {BigDecimal} interest 总费率
 * @apiParam {Integer} bankCardId 放款银行卡ID
 * @apiParam {BigDecimal} expectRepayAmount 预计每月还款金额
 *
 *
 * @apiSuccess {String}   success   正确错误
 * @apiSuccess {String}   message   消息
 * @apiSuccess {Object.boolean} data   返回数据
 *
 *
 * @apiSuccessExample {json} Success Example:
 * {
...
/**
 * @api  {post} v3/user/idCardOcr 身份证识别接口
 * @apiVersion 0.1.0
 * @apiname idCardOcr
 * @apiGroup User
 * @apiParam {String} idcardBase64Img 图片base64
 * @apiHeader {String} Authorization 认证头信息: Bearer {access_token}
 * @apiHeaderExample {String} Head Example:
 * Authorization: Bearer 4917172b-685e-4cdf-b518-21bb118018b5
 *
...
/**
 * @api  {post} v3/user/identityAuth 身份信息认证和保存
 * @apiPermission none
 * @apiVersion 0.1.0
 * @apiname identityAuthAndSave
 * @apiGroup User
 * @apiHeader {String} Authorization 认证头信息: Bearer {access_token}
 *
 * @apiParam {String} name 姓名
 * @apiParam {String} identityId 身份证号
 * @apiParam {String} identityAddress 身份证地址
 * @apiParam {String} startDate 有效起始日期
 * @apiParam {String} endDate 有效结束日期
 * @apiParam {String} identityCardFrontImage 身份证正面
 * @apiParam {String} identityCardOppositeImage 身份证反面
 * @apiParam {String} headImage 身份证证抠图照片
...
/**
 * @api  {post} v3/user/livingBodyAuthAndSave 人脸活体比对匹配和保存
 * @apiVersion 0.1.0
 * @apiname livingBodyAuthAndSave
 * @apiGroup User
...
/**
 * @api  {get} v3/order/queryLoanUseTypeList 查询借款用途
 * @apiVersion 0.1.0
 * @apiname queryLoanUseTypeList
 * @apiGroup Apply
 * @apiHeader {String} Authorization 认证头信息: Bearer {access_token}
 * @apiHeaderExample {String} Head Example:
 * Authorization: Bearer 4917172b-685e-4cdf-b518-21bb118018b5
...
/**
 * @api  {get} v3/order/queryInsuranceContractTpl 查询保险协议
 * @apiVersion 0.1.0
 * @apiname queryInsuranceContractTpl
 * @apiGroup Apply
 * @apiHeader {String} Authorization 认证头信息: Bearer {access_token}
 * @apiHeaderExample {String} Head Example:
 * Authorization: Bearer 4917172b-685e-4cdf-b518-21bb118018b5
 ...
 *   {
 *      "data":{
 *          "个人意外伤害保险条款":"http://testjkweb.tourongjia.com/templates/保险条款.pdf",
 *          "投保须知":"http://testjkweb.tourongjia.com/templates/投保须知.pdf"
 *      },
 *      "message":"成功",
 *      "success":true
 *  }
