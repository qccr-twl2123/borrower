...
/**
 * Created by baoyf13974 on 2016/2/2.
 */
/**
...
public class RSAHelper {
    ...
    public static PrivateKey localPrivKey;
    public static PublicKey peerPubKey;
     ...
     *            密钥长度, 一般2048
     */
    public static void initKey(String localPrivKeyBase64Str,
     ...
     * @throws Exception
     */
    public static byte[] encryptRSA(byte[] plainBytes, boolean useBase64Code, String charset)
            throws Exception {
        ...
        // cryptedBase64Str =
        // Base64.encodeBase64String(cipher.doFinal(plaintext.getBytes(Charset.defaultCharset())));
        // 分段加密
     ...
     * @throws Exception
     */
    public static byte[] decryptRSA(byte[] cryptedBytes, boolean useBase64Code,
